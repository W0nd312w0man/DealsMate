            ...
            <div className="space-y-8 max-w-2xl">
              <div className="space-y-4">
                ...
                <p className="text-xl text-purple-200 leading-relaxed">
                  DealsMate combines AI-powered document management, automated workflows, and compliance tracking into
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-purple-800/50 backdrop-blur-md rounded-3xl p-10 border border-purple-700/50">
              ...
              <p className="text-purple-200 mb-8 text-lg text-center">
                Join thousands of real estate professionals who have simplified their workflow with DealsMate.
              </p>
