...
export default function TransactionStatusBarDemoPage() {
  ...
  return (
    <div className="container py-8 space-y-8">
      <BreadcrumbNav />
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Transaction Status Bar Demo</h1>
        <p className="text-muted-foreground">Visualize the transaction progress with the "Needs Attention" status</p>
      </div>
      ...
      <Tabs defaultValue="interactive">
        ...
        <TabsContent value="interactive">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Customize the transaction status bar to see how "Needs Attention" works</CardDescription>
            </CardHeader>
                ...
                {showAttentionOptions && (
                  <>
                    ...
                    <div className="flex justify-end">
                      <Button onClick={handleResolveClick} className="bg-amber-500 hover:bg-amber-600 text-white">
                        Simulate Resolving Issue
                      </Button>
                    </div>
                  </>
                )}
        ...
        <TabsContent value="examples">
          <div className="space-y-6">
            <Card>
              <CardHeader>
                <CardTitle>Example: Normal Transaction Flow</CardTitle>
                <CardDescription>Showing a transaction progressing normally through the stages</CardDescription>
              </CardHeader>
              <CardContent>
                <TransactionProgressTracker currentStatus="commission-approved" />
              </CardContent>
            </Card>

            <Card>
              <CardHeader>
                <CardTitle>Example: Missing Documents</CardTitle>
                <CardDescription>
                  Showing a transaction that needs attention due to missing documents during the Under Review stage
                </CardDescription>
              </CardHeader>
              <CardContent>
                <TransactionProgressTracker
            ...
            <Card>
              <CardHeader>
                <CardTitle>Example: Commission Issue</CardTitle>
                <CardDescription>
                  Showing a transaction that needs attention due to a commission issue after broker approval
                </CardDescription>
              </CardHeader>
              <CardContent>
                <TransactionProgressTracker
                  ...
                  interruptedStage="broker-approved"
                />
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Example: Payment Issue</CardTitle>
                <CardDescription>
                  Showing a transaction that needs attention due to a payment issue during the disbursement stage
                </CardDescription>
              </CardHeader>
              <CardContent>
                <TransactionProgressTracker
                  currentStatus="needs-attention"
                  attentionReason="payment"
                  attentionDetails="Payment verification failed. Please check the payment details and try again."
                  interruptedStage="disbursed"
                />
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Showing a transaction that has been completed successfully</CardDescription>
              </CardHeader>
              <CardContent>
                <TransactionProgressTracker currentStatus="payment-issued" />
              </CardContent>
            </Card>
          </div>
        </TabsContent>
