...
export function TalosNotifications({ className }: TalosNotificationsProps) {
  ...
  useEffect(() => {
    const mockNotifications: TalosNotification[] = [
      {
        id: "n1",
        type: "task_created",
        title: "Schedule property viewing",
        description: "TALOS AI created a task based on client email from Karen Chen regarding 15614 Yermo Street.",
        ...
        relatedEntity: {
          type: "task",
          id: "task-123",
          name: "Schedule property viewing for Karen Chen",
        },
        priority: "high",
      },
      {
        ...
        title: "Purchase Agreement analyzed",
        description: "TALOS AI analyzed the Purchase Agreement for 456 Oak Avenue and extracted key information.",
        ...
        relatedEntity: {
          type: "document",
          id: "doc-456",
          name: "Purchase_Agreement_456_Oak_Avenue.pdf",
        },
      },
      {
        id: "n3",
        type: "email_analyzed",
        title: "Email from Robert Wilson analyzed",
        description: "TALOS AI detected important information about closing documents in an email from Robert Wilson.",
        ...
        relatedEntity: {
          type: "email",
          id: "email-789",
          name: "Closing documents for Cedar Lane property",
        },
      },
      {
        id: "n4",
        ...
        description: "TALOS AI created a calendar event for home inspection at 101 Cedar Lane based on email analysis.",
        ...
        relatedEntity: {
          type: "event",
          id: "event-101",
          name: "Home Inspection - 101 Cedar Lane",
        },
      },
      {
        id: "n5",
        ...
        description: "TALOS AI detected a compliance deadline for transaction TX-1234 that requires attention.",
        ...
        relatedEntity: {
          type: "transaction",
          id: "tx-1234",
          name: "15614 Yermo Street Transaction",
        },
      },
    ]
